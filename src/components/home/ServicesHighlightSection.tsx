...
export function ServicesHighlightSection() {
  const t = useTranslations("servicesHighlight");

  const services = [
    {
      id: 1,
      title: t("seamlessSolutions.title"),
      description: t("seamlessSolutions.description"),
      icon: Settings,
      href: "/services",
      image:
        "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800&q=80",
      features: [
        t("seamlessSolutions.features.0"),
        t("seamlessSolutions.features.1"),
        t("seamlessSolutions.features.2"),
        t("seamlessSolutions.features.3"),
      ],
    },
    {
      id: 2,
      ...
      features: [
        t("localService.features.0"),
        t("localService.features.1"),
        t("localService.features.2"),
        t("localService.features.3"),
      ],
    },
    {
      id: 3,
      title: t("globalService.title"),
      description: t("globalService.description"),
      icon: Globe2,
      href: "/global-service",
      image:
        "https://images.unsplash.com/photo-1566576721346-d4a3b4eaeb55?w=800&q=80",
      features: [
        t("globalService.features.0"),
        t("globalService.features.1"),
        t("globalService.features.2"),
        t("globalService.features.3"),
      ],
    },
  ];
