...
export function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      {/* Main Button */}
      <div className="relative w-14 h-14 sm:w-16 sm:h-16 bg-[#25D366] hover:bg-[#20BA5A] rounded-full shadow-2xl flex items-center justify-center transition-all duration-300 transform hover:scale-110">
