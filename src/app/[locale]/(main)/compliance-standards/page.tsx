  ...
  return (
    ...
    >
      ...
      <DocSection id="overview" title="Compliance & Standards Overview">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Rigid commitment to international laws, ethical sourcing, and
              quality benchmarks in every transaction.
            </p>
          </div>
        </div>

        <p>
          At Zexfro International Limited, we recognize that trust is the
          primary currency in global trade. Operating in the export–import
          sector requires more than just logistics; it requires rigid commitment
          to international laws, ethical sourcing, and quality benchmarks.
        </p>
        ...
        <p>
          This overview outlines the Compliance & Standards framework that
          governs our operations, ensuring that every shipment, partnership, and
          transaction meets the highest international standards of quality,
        ...
        <div className="bg-blue-50 border-l-4 border-[#0a4a9e] p-6 my-6">
          ...
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Regulatory Compliance:</strong> Strict adherence to
            ...
            <li className="flex items-start gap-3">
              <span className="text-[#0a4a9e] font-bold">•</span>
              <span>
                <strong>Quality Standards:</strong> ISO-aligned processes and
            ...
            <li className="flex items-start gap-3">
              <span className="text-[#0a4a9e] font-bold">•</span>
              <span>
                <strong>Ethical Sourcing:</strong> Responsible supply chain
                practices and labor rights protection
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-[#0a4a9e] font-bold">•</span>
        ...
        <div className="bg-gradient-to-r from-[#0a4a9e] to-[#05306b] rounded-lg p-6 text-white text-center">
          ...
          <p className="mt-2 text-white/90">
            Our comprehensive framework ensures that every aspect of our
            operations meets or exceeds international standards.
          </p>
        </div>
      </DocSection>
      ...
      <DocSection id="regulatory" title="Regulatory & Trade Compliance">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Ensuring smooth cross-border transactions through strict
        ...
        <p>
          To ensure smooth cross-border transactions, we strictly adhere to both
          local and international trade regulations. Our regulatory compliance
          framework is comprehensive, covering all aspects of international
          trade from documentation to partner screening.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-6">
          <div className="bg-green-50 border-2 border-green-200 rounded-lg p-6">
            ...
            <p className="text-sm text-gray-700 mb-4">
              We maintain 100% accuracy in documentation to prevent delays,
          ...
          <div className="bg-green-50 border-2 border-green-200 rounded-lg p-6">
            ...
            <p className="text-sm text-gray-700 mb-4">
              Every partner, vendor, and financial institution is screened
          ...
          <div className="bg-green-50 border-2 border-green-200 rounded-lg p-6">
            ...
            <p className="text-sm text-gray-700 mb-4">
              Zero-tolerance policy regarding corruption and bribery in all
              forms.
            </p>
            <ul className="space-y-2 text-sm text-gray-700">
              <li className="flex items-start gap-2">
        ...
        <div className="bg-green-50 border-l-4 border-green-600 p-6 my-6">
          ...
          <p className="text-gray-700 mb-3">
            We operate under a zero-tolerance policy regarding the Foreign
            Corrupt Practices Act (FCPA) and local anti-corruption laws. This
            commitment includes:
          </p>
          <ul className="space-y-2 text-gray-700">
            <li className="flex items-start gap-3">
              ...
              <span>
                Prohibition of payments, gifts, or anything of value to foreign
            ...
            <li className="flex items-start gap-3">
              <span className="text-green-600 font-bold">•</span>
              <span>
                Accurate books and records that reflect all business
                transactions
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-green-600 font-bold">•</span>
              <span>
                Internal controls to ensure compliance with anti-corruption laws
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-green-600 font-bold">•</span>
              <span>
                Regular training for employees on FCPA and anti-corruption
                regulations
              </span>
            </li>
          </ul>
        ...
        <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-lg p-6 text-white text-center">
          <p className="text-xl font-bold">
            100% Regulatory Compliance, 0% Compromise
          </p>
          <p className="mt-2 text-white/90">
            Our strict adherence to international trade regulations ensures
            legal, ethical, and smooth business operations.
          </p>
        </div>
      </DocSection>
      ...
      <DocSection id="quality" title="Quality Assurance & Standards">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Every shipment leaving or entering our warehouses meets the
        ...
        <p>
          Quality is not just a goal; it is a prerequisite for every shipment
          leaving or entering our warehouses. We maintain rigorous quality
          assurance processes aligned with international standards to ensure
          consistent excellence in every transaction.
        </p>
        ...
        <div className="bg-purple-50 border-l-4 border-purple-600 p-6 my-6">
          ...
          <p className="text-gray-700 mb-4">
            We align our processes with{" "}
            <strong>ISO 9001:2015 (Quality Management Systems)</strong> to
            ensure consistency in service delivery. This international standard
            helps us:
          </p>
          <ul className="space-y-2 text-gray-700">
            <li className="flex items-start gap-3">
              ...
              <span>
                Demonstrate our ability to consistently provide products and
            ...
            <li className="flex items-start gap-3">
              <span className="text-purple-600 font-bold">•</span>
              <span>
                Enhance customer satisfaction through effective application of
                the system
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-purple-600 font-bold">•</span>
              <span>
                Address risks and opportunities associated with our context and
                objectives
              </span>
            </li>
            <li className="flex items-start gap-3">
        ...
        <p>
          Depending on the cargo (e.g., textiles, electronics, or perishables),
          we ensure compliance with relevant international standards that
          guarantee safety, quality, and market acceptance.
        </p>
        ...
        <div className="bg-gradient-to-r from-purple-600 to-purple-700 rounded-lg p-6 text-white text-center">
          ...
          <p className="mt-2 text-white/90">
            ISO-aligned processes and product-specific certifications ensure
      ...
      <DocSection id="ethical" title="Ethical Sourcing & Social Compliance">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600">
              A sustainable supply chain is a responsible one—ensuring fair
              treatment of people and the environment.
            </p>
          </div>
        </div>

        <p>
          We believe that a sustainable supply chain is a responsible one. We
          vet our suppliers based on their treatment of people and the
          environment, ensuring that every partner in our network upholds the
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
          <div className="bg-yellow-50 border-2 border-yellow-200 rounded-lg p-6">
            ...
            <p className="text-sm text-gray-700 mb-4">
              We strictly prohibit exploitation and unfair practices within our
              supply chain.
            </p>
            <ul className="space-y-3 text-sm text-gray-700">
              <li className="flex items-start gap-3">
                ...
                <span>
                  <strong>Zero Child Labor:</strong> Absolute prohibition of
              ...
              <li className="flex items-start gap-3">
                <span className="text-yellow-600 font-bold">•</span>
                <span>
                  <strong>No Forced Labor:</strong> Workers must be employed
                  voluntarily with freedom to leave
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-yellow-600 font-bold">•</span>
                <span>
                  <strong>Fair Wages:</strong> Payment of at least minimum wage
                  and living wage where possible
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-yellow-600 font-bold">•</span>
                <span>
                  <strong>Safe Working Conditions:</strong> Compliance with
              ...
              <li className="flex items-start gap-3">
                <span className="text-yellow-600 font-bold">•</span>
                <span>
                  <strong>Freedom of Association:</strong> Right to form and
                  join trade unions
                </span>
              </li>
            </ul>
          ...
          <div className="bg-yellow-50 border-2 border-yellow-200 rounded-lg p-6">
            ...
            <p className="text-sm text-gray-700 mb-4">
              Regular verification of workplace safety and ethical conditions
            ...
            <ul className="space-y-3 text-sm text-gray-700">
              <li className="flex items-start gap-3">
                <span className="text-yellow-600 font-bold">•</span>
                <span>
                  <strong>On-Site Inspections:</strong> Our team conducts
              ...
              <li className="flex items-start gap-3">
                <span className="text-yellow-600 font-bold">•</span>
                <span>
                  <strong>Third-Party Audits:</strong> Utilization of SEDEX or
                  BSCI certified auditors
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-yellow-600 font-bold">•</span>
                <span>
                  <strong>Workplace Safety:</strong> Verification of safe
              ...
              <li className="flex items-start gap-3">
                <span className="text-yellow-600 font-bold">•</span>
                <span>
                  <strong>Corrective Action Plans:</strong> Support for
              ...
              <li className="flex items-start gap-3">
                <span className="text-yellow-600 font-bold">•</span>
                <span>
                  <strong>Continuous Monitoring:</strong> Ongoing compliance
                  verification
                </span>
              </li>
            </ul>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-sm text-gray-700">
                Global platform for sharing ethical supply chain data, covering
                labor standards, health & safety, environment, and business
                ethics.
              </p>
            </div>
            <div>
              ...
              <p className="text-sm text-gray-700">
                European framework for improving working conditions in global
                supply chains through a common monitoring system.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-yellow-600 to-yellow-700 rounded-lg p-6 text-white text-center">
          ...
          <p className="mt-2 text-white/90">
            Our commitment to ethical sourcing protects workers' rights and
            promotes fair labor practices throughout our global network.
          </p>
        </div>
      </DocSection>
      ...
      >
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Commitment to environmental sustainability through eco-friendly
              practices and green logistics.
            </p>
          </div>
        </div>

        <p>
          Zexfro International Limited is committed to reducing the carbon
          footprint of global logistics. We recognize that environmental
          responsibility is essential for sustainable business operations and
          actively implement practices that minimize our environmental impact.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
          <div className="bg-orange-50 border-2 border-orange-200 rounded-lg p-6">
            ...
            <p className="text-sm text-gray-700 mb-4">
              We prioritize biodegradable or recyclable packaging materials
              wherever possible.
            </p>
            <ul className="space-y-2 text-sm text-gray-700">
              <li className="flex items-start gap-3">
                ...
                <span>
                  <strong>Biodegradable Materials:</strong> Use of materials
              ...
              <li className="flex items-start gap-3">
                <span className="text-orange-600 font-bold">•</span>
                <span>
                  <strong>Recyclable Packaging:</strong> Materials that can be
              ...
              <li className="flex items-start gap-3">
                <span className="text-orange-600 font-bold">•</span>
                <span>
                  <strong>Minimal Packaging:</strong> Reducing excess materials
              ...
              <li className="flex items-start gap-3">
                <span className="text-orange-600 font-bold">•</span>
                <span>
                  <strong>Sustainable Sources:</strong> Packaging from
              ...
              <li className="flex items-start gap-3">
                <span className="text-orange-600 font-bold">•</span>
                <span>
                  <strong>Reusable Options:</strong> Encouraging packaging that
          ...
          <div className="bg-orange-50 border-2 border-orange-200 rounded-lg p-6">
            ...
            <p className="text-sm text-gray-700 mb-4">
              Working with carriers that utilize sustainable practices to
            ...
            <ul className="space-y-2 text-sm text-gray-700">
              <li className="flex items-start gap-3">
                <span className="text-orange-600 font-bold">•</span>
                <span>
                  <strong>Fuel-Efficient Vessels:</strong> Carriers using
                  modern, efficient ships and aircraft
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-orange-600 font-bold">•</span>
                <span>
                  <strong>Optimized Routing:</strong> Planning routes to
              ...
              <li className="flex items-start gap-3">
                <span className="text-orange-600 font-bold">•</span>
                <span>
                  <strong>CO₂ Emission Reduction:</strong> Active monitoring and
              ...
              <li className="flex items-start gap-3">
                <span className="text-orange-600 font-bold">•</span>
                <span>
                  <strong>Consolidated Shipments:</strong> Combining cargo to
                  reduce trips
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-orange-600 font-bold">•</span>
                <span>
                  <strong>Paperless Operations:</strong> Digital documentation
        ...
        <div className="bg-orange-50 border-l-4 border-orange-600 p-6 my-6">
          ...
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start gap-3">
              <span className="text-orange-600 font-bold">•</span>
              <span>
                <strong>Transitioning to Paperless Operations:</strong> Digital
                documentation and electronic communication reducing paper
                consumption
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-orange-600 font-bold">•</span>
              <span>
                <strong>Low-Carbon Trade Practices:</strong> Selecting
                environmentally responsible carriers and routes
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-orange-600 font-bold">•</span>
              <span>
                <strong>Sustainable Partner Selection:</strong> Preferring
            ...
            <li className="flex items-start gap-3">
              <span className="text-orange-600 font-bold">•</span>
              <span>
                <strong>Continuous Improvement:</strong> Regular review and
        ...
        <div className="bg-gradient-to-r from-orange-600 to-orange-700 rounded-lg p-6 text-white text-center">
          ...
          <p className="mt-2 text-white/90">
            Our commitment to environmental sustainability ensures responsible
            business practices that benefit both commerce and the environment.
          </p>
        </div>
      </DocSection>
      ...
      <DocSection id="pillars" title="Our Compliance Pillars">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Our comprehensive framework built on integrity, quality, people,
              and planet.
            </p>
          </div>
        </div>
        ...
        <p>
          Our compliance framework rests on four fundamental pillars that guide
          every decision, partnership, and transaction. These pillars represent
          our unwavering commitment to excellence across all dimensions of our
          business operations.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
          <div className="bg-teal-50/20 border-2 border-teal-300 rounded-lg p-6 hover:border-teal-400 transition-colors">
            ...
            <p className="text-sm text-gray-700 mb-3">
              Our commitment to financial and legal integrity ensures that every
              transaction is conducted with the highest ethical standards.
            </p>
            <ul className="space-y-2 text-sm text-gray-700">
          ...
          <div className="bg-teal-50/20 border-2 border-teal-300 rounded-lg p-6 hover:border-teal-400 transition-colors">
            ...
            <p className="text-sm text-gray-700 mb-3">
              Quality excellence through rigorous inspection and testing ensures
          ...
          <div className="bg-teal-50/20 border-2 border-teal-300 rounded-lg p-6 hover:border-teal-400 transition-colors">
            ...
            <p className="text-sm text-gray-700 mb-3">
              Fair labor practices and worker dignity are fundamental to our
          ...
          <div className="bg-teal-50/20 border-2 border-teal-300 rounded-lg p-6 hover:border-teal-400 transition-colors">
            ...
            <p className="text-sm text-gray-700 mb-3">
              Environmental responsibility through sustainable practices that
        ...
        <div className="bg-gradient-to-r from-teal-600 to-teal-700 rounded-lg p-6 text-white text-center">
          <p className="text-xl font-bold">
            Four Pillars, One Commitment: Excellence
          </p>
          <p className="mt-2 text-white/90">
            Our compliance framework ensures that we deliver exceptional value
            while maintaining the highest standards of integrity, quality,
        ...
        <div className="bg-gradient-to-r from-[#0a4a9e] to-[#05306b] rounded-lg p-8 text-white my-8">
          ...
          <p className="mb-6 text-white/90">
            Our comprehensive compliance framework ensures that every aspect of
            our operations meets or exceeds international standards. Experience
            the confidence that comes from working with a truly compliant and
